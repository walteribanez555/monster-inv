...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'preparations/view', component: PreparationsComponent },
      { path: 'preparations/view/:id', component: PreparationsComponent },
      { path: 'preparations/create', component: PreparationComponent },
      { path: 'preparations/create/:id', component :PreparationComponent},
